...
const SMOKE_MILESTONES = [
  ...
  { mins:4680,    marker:'78h',  label:'78 horas',   type:'info',    text:'78h. O cérebro começa a reparar receptores de dopamina. Prazer natural voltando aos poucos.' },
  { mins:5040,    marker:'84h',  label:'84 horas',   type:'boost',   text:'84h — 3 dias e meio! Brônquios relaxam, respirar fica visivelmente mais fácil.'            },
  { mins:5400,    marker:'90h',  label:'90 horas',   type:'warning', text:'90h. Fissuras psicológicas podem surgir de situações — café, pós-refeição. Troque o hábito por água ou respiração.' },
  { mins:5760,    marker:'96h',  label:'4 dias',     type:'boost',   text:'4 dias completos! Energia aumentando, humor estabilizando. Você está reescrevendo sua história.' },
  { mins:6120,    marker:'102h', label:'102 horas',  type:'info',    text:'102h. Circulação melhorou — extremidades mais quentes, pele com mais cor.'                 },
  { mins:6480,    marker:'108h', label:'108 horas',  type:'boost',   text:'108h. Quase 4 dias e meio. O corpo está em modo de cura ativa — cada hora conta.'          },
  { mins:6840,    marker:'114h', label:'114 horas',  type:'info',    text:'114h. Paladar e olfato cada vez mais aguçados — você vai sentir o sabor da comida diferente.' },
  { mins:7200,    marker:'5d',   label:'5 dias',     type:'boost',   text:'5 dias! As fissuras duram menos e vêm com menos força. O pior definitivamente já passou.'  },
  { mins:7560,    marker:'126h', label:'126 horas',  type:'info',    text:'126h. Seu fígado está metabolizando toxinas acumuladas. Beba água — ajuda a limpar mais rápido.' },
  { mins:7920,    marker:'132h', label:'132 horas',  type:'boost',   text:'132h. 5 dias e meio de pura força. Quando a fissura bater, lembre: você já aguentou tudo isso.' },
  { mins:8280,    marker:'138h', label:'138 horas',  type:'warning', text:'138h. Gatilhos emocionais (estresse, tédio) ainda podem provocar vontade. Respire fundo — passa.'  },
  { mins:8640,    marker:'6d',   label:'6 dias',     type:'boost',   text:'6 dias! Quase uma semana. Seu cérebro está se adaptando a funcionar sem nicotina — e está indo bem.' },
  { mins:9000,    marker:'150h', label:'150 horas',  type:'info',    text:'150h. Produção de muco nos pulmões normalizando — tosse de limpeza pode aparecer, é bom sinal.' },
  { mins:9360,    marker:'156h', label:'156 horas',  type:'boost',   text:'156h. Você está na reta final da primeira semana. Muito poucos chegam até aqui — você chegou.' },
  { mins:9720,    marker:'162h', label:'162 horas',  type:'info',    text:'162h. Quase 7 dias. Receptores de nicotina no cérebro continuam diminuindo. Liberdade chegando.' },
